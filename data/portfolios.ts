...
},
{
  ...
  city: "Astana",
  season: "CENTERSTAGE",
  level: "Nationals / International events",
  stars: "★★★☆☆",
  score: "33 / 55",
  award: "Inspire (attempted)",

  cover: "/portfolios/24881-1/cover.png",
  pdf: "/portfolios/24881-1/portfolio.pdf",

  summary:
    "A strong and active FTC portfolio with a heavy emphasis on outreach, community engagement, and international networking. The team demonstrates sustained programs, large-scale initiatives, and visibility beyond the FTC ecosystem, but the engineering and technical depth do not yet reach Inspire or Champions-level standards.",
  ...
  strengths: [
    "Large-scale and sustained outreach including forums, mentoring programs, media appearances, and work with diverse audiences.",
    "Strong regional and international connections with FTC teams, universities, judges, and industry partners.",
    "Clear robot iteration history demonstrating identification of problems and incremental mechanical improvements."
  ],

  weaknesses: [
    "Many major outreach and impact claims lack verifiable evidence such as external links, screenshots, or independent confirmation.",
    "Engineering explanations focus on describing solutions rather than analyzing alternatives, failures, and trade-offs.",
    "Technical calculations and research sections contain simplifications that reduce overall credibility."
  ],

  improvements: [
    "Add verifiable proof for all outreach metrics, including attendance numbers, media coverage, and long-term impact indicators.",
    "Reframe engineering sections to explicitly show decision-making, rejected alternatives, and quantitative testing results.",
    "Strengthen alignment with FTC Judging Questions by mapping each major activity directly to award criteria."
  ],
